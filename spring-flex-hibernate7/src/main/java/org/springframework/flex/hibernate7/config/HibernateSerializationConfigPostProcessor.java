...
public class HibernateSerializationConfigPostProcessor implements BeanFactoryPostProcessor {
    ...
    private static final String HIBERNATE_CONFIG_PROCESSOR_CLASS = "org.springframework.flex.hibernate7.config.HibernateConfigProcessor";
    
    private static final String JPA_HIBERNATE_CONFIG_PROCESSOR_CLASS = "org.springframework.flex.hibernate7.config.JpaHibernateConfigProcessor";
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        ...
        if (isHibernateDetected(beanFactory.getBeanClassLoader())) {
            ...
            Assert.notNull(messageBrokerBeanDef,"Could not find an appropriate bean definition for MessageBrokerBeanDefinitionFactoryBean.");
    ...
    private boolean isJpaDetected(ClassLoader classLoader) {
        return ClassUtils.isPresent("jakarta.persistence.EntityManagerFactory", classLoader);
    }
}
