...
public class RuntimeEnvironmentTests extends AbstractRuntimeEnvironmentAwareTests {
    ...
    @Test
    public void isHibernate7SupportAvailable() {
        assertTrue(RuntimeEnvironment.isHibernate7SupportAvailable());
    }
    ...
    @Test
    public void isSpringFlexHibernate7SupportAvailable() {
        assertTrue(RuntimeEnvironment.isSpringFlexHibernate7SupportAvailable());
    }
